...
function getRoomUsersNname(roomUsersUid, currentUserID) {
  ...
  function createScore(score, i) {
    ...
    style.type = 'text/css';
    style.innerHTML = '.progress-done-' + i + ' { background-color: #2be0e0; box-shadow: 0 3px 3px -5px #f7c7c7c, 0 2px 5px #7c7c7c; border-radius: 20px 0 0 20px; color: #fff; display: flex; align-items: center; justify-content: center; height: 100%; width: 0%; opacity: 0; transition: 1s ease 0.3s;}';
