...
window.onload = function(){
    ...
    firebase.database().ref('Rooms/' + roomName + '/Users').once('value').then(function(snapshot)
    {
      snapshot.forEach(function(childSnapshot) {
        ...
        roomUsersUid = childSnapshot.key;
...
function deleteRoom() {
  ...
  if(confirm("정말 방을 삭제하시겠습니까?") == true){
    $.when(delRoom(roomName), delUsersRoom(roomName)).done(function(){
      alert('방이 삭제되었습니다.');
...
//===========================================================================//
//방 삭제하기 -> UsersRoom 삭제 (히스토리 안남김)
//==========================================================================//
function delUsersRoom(rName) {
  var deferred = $.Deferred();
  delUsersRoomtoCall(rName);
  deferred.resolve();
...
//===========================================================================//
//방 삭제하기 호출용 함수 (히스토리 안남김)
//==========================================================================//
function delUsersRoomtoCall(rName) {
  for (var i in roomUsers) {
    firebase.database().ref('Usersroom/' + roomUsers[i] +'/' + rName).remove();
  }
}

//==========================================================================//
//방 삭제하기 -> Rooms 삭제 (히스토리 안남김)
//===========================================================================//
